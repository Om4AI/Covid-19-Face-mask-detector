...
#### 5. Real time face mask detection has been included in the repository now. I have used OpenCV to take only the face area of the person and feed it to the model that would be a saved H5 file.
